...
CREATE TABLE `t_channel_config` (
  ...
  `start_date` bigint(20) DEFAULT NULL COMMENT '启用时间',
  `end_date` bigint(20) DEFAULT NULL COMMENT '停用时间',
...
CREATE TABLE `t_charge` (
  ...
  `receipt_app_id` int(11) NOT NULL COMMENT '收款方应用id',
  ...
  `transaction_no` varchar(32) DEFAULT NULL COMMENT '支付渠道订单号',
  `time_created` bigint(20) DEFAULT NULL COMMENT '支付单创建时间，13位Unix时间戳',
  `time_paid` bigint(20) DEFAULT NULL COMMENT '支付单支付完成时间，13位Unix时间戳',
  `time_expire` bigint(20) DEFAULT NULL COMMENT '支付单单失效时间，单位分钟',
  `expire_timestamp` bigint(20) DEFAULT NULL COMMENT '订单失效时间，13位Unix时间戳',
...
CREATE TABLE `t_refund` (
  ...
  `transaction_no` varchar(32) DEFAULT NULL COMMENT '支付渠道退款订单号',
